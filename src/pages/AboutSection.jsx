...
const AboutSection = forwardRef((props, ref) => {
  ...
  return (
    <section ref={ref} className="relative min-h-screen overflow-hidden">
      ...
      {/* About Content */}
      <motion.div
        className="relative z-40 flex items-center justify-center h-screen px-8 pt-2 pb-20"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
      >
        {/* Content Box */}
        <div className="flex w-full max-w-7xl h-5/6 bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-lg rounded-3xl border border-gradient-to-r from-amber-200/30 via-gray-300/20 to-gray-400/30 shadow-2xl overflow-hidden">
          
          {/* Left Side - Profile Card (1/3) */}
          <motion.div 
            className="w-1/3 p-8 flex flex-col items-center justify-center bg-gradient-to-b from-gray-800/50 to-gray-900/70 border-r border-amber-200/20"
          ...
          >
            ...
            <div className="relative mb-6">
              <div className="w-72 h-72 rounded-3xl overflow-hidden border-4 border-gradient-to-r from-amber-200 via-gray-300 to-gray-400 shadow-2xl">
                <img 
                  src="/profile.jpg" 
                  alt="Harshita Yadav" 
              ...
              {/* Sparkle decorations */}
              <div className="absolute -top-3 -right-3 text-amber-200 text-3xl">✨</div>
              <div className="absolute -bottom-3 -left-3 text-gray-300 text-2xl">⭐</div>
            </div>
            ...
            >
              <h2 className="text-3xl font-bold bg-gradient-to-r from-amber-200 via-gray-300 to-gray-400 bg-clip-text text-transparent">
                Harshita Yadav
              </h2>
            </motion.div>

            {/* Social Profiles - Two Row Layout */}
            <motion.div 
            ...
            >
              {socialProfiles.map((profile, index) => (
                <motion.a
                  ...
                  className="relative group flex items-center justify-center w-12 h-12 mx-auto text-white hover:text-amber-200 transition-all duration-300"
                ...
                >
                  ...
                  {/* Tooltip */}
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap shadow-lg border border-gray-600">
                    {profile.name}
          ...
          {/* Right Side - About Content (2/3) */}
          <motion.div 
            className="w-2/3 p-12 flex flex-col justify-center"
            initial={{ x: 100, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
          ...
          >
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Name */}
                <div className="group">
                  <label className="text-amber-200 font-semibold text-sm uppercase tracking-wide">Name</label>
                  <div className="mt-2 p-4 bg-gray-800/50 rounded-xl border border-gray-600/30 group-hover:border-amber-200/40 transition-all duration-300">
                    <p className="text-white font-medium">Harshita Yadav</p>
                  </div>
                </div>

                {/* Location */}
                <div className="group">
                  <label className="text-gray-300 font-semibold text-sm uppercase tracking-wide">Location</label>
                  <div className="mt-2 p-4 bg-gray-800/50 rounded-xl border border-gray-600/30 group-hover:border-gray-300/40 transition-all duration-300">
                    <p className="text-white font-medium">Gurugram</p>
                  </div>
                </div>

                {/* Profession */}
                <div className="group">
                  <label className="text-gray-400 font-semibold text-sm uppercase tracking-wide">Profession</label>
                  <div className="mt-2 p-4 bg-gray-800/50 rounded-xl border border-gray-600/30 group-hover:border-gray-400/40 transition-all duration-300">
                    <p className="text-white font-medium">3rd year student at IIIT Kota</p>
                  </div>
                </div>

                {/* Gender */}
                <div className="group">
                  <label className="text-amber-100 font-semibold text-sm uppercase tracking-wide">Gender</label>
                  <div className="mt-2 p-4 bg-gray-800/50 rounded-xl border border-gray-600/30 group-hover:border-amber-100/40 transition-all duration-300">
              ...
              {/* Tech Stack Hint */}
              <motion.div 
                className="mt-8 p-6 bg-gradient-to-r from-amber-200/10 via-gray-300/5 to-gray-400/10 rounded-2xl border border-amber-200/20"
